...
import {ModalFormRef, ProFormOption} from 'tdesign-pro-component';
const modalFormRef = ref<ModalFormRef>();
...
<template>
    <div>
        ...
        <ModalForm ref="modalFormRef" :request enableTip autoClose  width="800px" v-model:loading="loading" @submit="handleSubmit" :header v-model:visible="visible" :options="options">
            <template #footer>
