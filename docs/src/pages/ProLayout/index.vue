...
import { ref } from 'vue';
import { type ProLayoutRoute } from 'tdesign-pro-component';
...
const HeaderRender = () => <div style="padding: 0 12px;">
    <t-head-menu expand-type="popup">
        <t-menu-item value="1">欢迎页</t-menu-item>
        <t-menu-item value="2">管理页</t-menu-item>
        <t-menu-item value="3">列表页</t-menu-item>
    </t-head-menu>
</div>
...
function handleMenuClick(_path: string, route: ProLayoutRoute) {
...
<template>
    ...
    <MdPreview :preview="true" style="margin-top: 24px;" id="pro-form-text-password" v-model="MarkdownContent"></MdPreview>
    <img src="https://pica.zhimg.com/80/v2-fd1e1b1b316713f67459511f9905c4a0_720w.webp" alt="">
    <img src="https://picx.zhimg.com/v2-b31b64035038d74933a8ea86119b9f4b_r.jpg" alt="">
    <img src="https://pica.zhimg.com/80/v2-fd1e1b1b316713f67459511f9905c4a0_720w.webp" alt="">
</template>