...
<template>
    <t-card style="margin-top: 24px;">
        ...
        <ProFormRadio :radioProps="{updateColor: styleValue.includes('color'), fill: styleValue.includes('fill')}" theme="tag" :data="data" label="豆腐脑吃甜的还是咸的" name="taste" v-model="taste"/>
