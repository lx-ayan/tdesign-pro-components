...
<template>
  <ProTable v-model:select-data="selectData" v-model:data-source="dataSource" :drag-able="true" select-type="multiple"
    :select-able="true" :request="request" :options="options">
