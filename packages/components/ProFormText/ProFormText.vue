...
<template>
    <t-form-item :label="props.label" :name="props.name" :rules="props.rules" :labelWidth="props.labelWidth"
        ...
        <t-input-adornment v-if="(slots.prepend || slots.append || props.prepend || props.append)"
            ...
            <t-input ref="inputRef" :readonly="props.readonly" :autofocus="props.autofocus"
                :borderless="props.borderless" :clearable="props.clearable" :disabled="props.disabled"
                :size="props.size" :type="props.type" :align="props.align" v-model="innerValue" @input="handleInput"
                @change="handleChange" @blur="handleBlur" @focus="handleFocus" @clear="handleClear" @click="handleClick"
                @keydown="handleKeydown" @keypress="handleKeypress" @keyup="handleKeyup" @mouseenter="handleMouseenter"
                @mouseleave="handleMouseleave" @paste="handlePaste" @validate="handleValidate" @wheel="handleWheel"
                :placeholder="props.placeholder || `请输入${label || '数据'}`" v-bind="props.inputProps">
        ...
        <t-input v-else ref="tInputRef" :readonly="props.readonly" :autofocus="props.autofocus"
            :borderless="props.borderless" :clearable="props.clearable" :disabled="props.disabled" :size="props.size"
            :type="props.type" :align="props.align" @input="handleInput" v-model="innerValue" @change="handleChange"
            @blur="handleBlur" @focus="handleFocus" @clear="handleClear" @click="handleClick" @keydown="handleKeydown"
            @keypress="handleKeypress" @keyup="handleKeyup" @mouseenter="handleMouseenter"
            @mouseleave="handleMouseleave" @paste="handlePaste" @validate="handleValidate" @wheel="handleWheel"
            :placeholder="props.placeholder || `请输入${label || '数据'}`" v-bind="props.inputProps">
            <template v-if="slots.suffixIcon" #suffixIcon>
                <slot name="suffixIcon"></slot>
