...
const ProTable = defineComponent(
    //@ts-ignore
    <T extends Record<string, any>>(props: ProTableProps<T>, {slots, emit, expose}: any) => {
                                ...
                                if(option && option.edit) {
                                    ...
                                    if(option.edit.beforeEdit) {
                                        option.edit.beforeEdit().then(() => {
                                            ...
                                            //@ts-ignore
                                            option.edit && option.edit.onEditFail && option.edit.onEditFail(e);
                                        }) 
                                    } else {
                                        doEdit()
                                    }
